...
module UtilEdge = 
    ...
    let [<Literal>] StartReset        = EdgeType.Reset ||| EdgeType.Bidirectional ||| EdgeType.EditorStartReset       // A=>B	    약시작리셋
    let [<Literal>] Interlock         = EdgeType.Reset ||| EdgeType.Bidirectional ||| EdgeType.Strong  ||| EdgeType.EditorInterlock      // A<||>B	    인터락 연결             
