...
namespace Dsu.Common.Utilities.ExtensionMethods
{
    ...
    public static class EmDataRow
    {
        ...
        public static IEnumerable<DataRow> SelectAddedRows(this DataTable tbl) => tbl.AsEnumerable().Where(r => r.RowState == DataRowState.Added);
        public static IEnumerable<DataRow> SelectModifiedRows(this DataTable tbl) => tbl.AsEnumerable().Where(r => r.RowState == DataRowState.Modified);
