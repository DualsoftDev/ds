...
namespace Dsu.Common.CS.LSIS.Actions
{
	/// <summary>
	...
	public class ActionList : System.ComponentModel.Component, IExtenderProvider
	{
        ...
        private int                 _updateCmdUISleepIntervalOnIdle = 0;
		#endregion
        ...
        // by kwak
        public int UpdateCmdUISleepIntervalOnIdle { get { return _updateCmdUISleepIntervalOnIdle; }  set { _updateCmdUISleepIntervalOnIdle = value; }}
		...
		private void OnIdle(Object sender, EventArgs e)
		{
            ...
            if ( _updateCmdUISleepIntervalOnIdle > 0 )
                System.Threading.Thread.Sleep(_updateCmdUISleepIntervalOnIdle);
		}
		/// <summary>
