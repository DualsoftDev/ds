...
type LibraryPptLoaderExt =
    ...
    [<Extension>]
        static member saveLibraryConfig(directoryPath:string) =
            ...
            let pptParms:PptParams = {HwTarget = getDefaltHwTarget();UserTagConfig= {UserTags = [||]};  AutoIOM = true; CreateFromPpt = false; CreateBtnLamp = false; StartMemory = 1000; OpMemory = 100}
