...
[sys] DS_Units_V13 = {
    ...
    [device file="./dsLib/AutoGen/16 Auto Pre 조건(자동운전시 전제조건 수동조작가능)__System2.ds"] "16 Auto Pre 조건(자동운전시 전제조건 수동조작가능)__System2"; 
    [device file="./dsLib/AutoGen/9 Negative 입력 옵션__System1.ds"] "9 Negative 입력 옵션__System1"; 
    [versions] = {
        DS-Langugage-Version = 1.0.0.1;
        DS-Engine-Version = 0.9.10.17;
    }
}
