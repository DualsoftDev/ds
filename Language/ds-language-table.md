...
|SEQ5|Causal Split|`;`| `A,B > D;C > D` | Action D would be executed by causal action A and B<p> Or action D would be executed by causal action C <p>`D행위는 A행위, B행위에 의해 실행되거나, C행위에 의해 실행됨`| ![AAA](./png/Seq5.dio.png)|
