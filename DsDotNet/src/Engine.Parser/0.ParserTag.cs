...
public abstract class Tag : IBitReadWritable, ITxRx
{
    public ICoin Owner { get; set; }
    public TagType Type { get; set; }
    bool _value { get; set; }

    bool IBitWritable.SetValue => throw new NotImplementedException();
    ...
    protected Tag(ParserCpu ownerCpu, ICoin owner, string name, TagType tagType = TagType.None, bool value = false)
...
public class TagA : Tag
{
    ...
    public TagA(ParserCpu ownerCpu, ICoin owner, string name, string address, TagType tagType, bool value = false)
...
{
    public TagP(ParserCpu ownerCpu, ICoin owner, string name, TagType tagType, bool value = false)
        : base(ownerCpu, owner, name, tagType, value)
    { }
}
...
{
    public TagE(ParserCpu ownerCpu, ICoin owner, string name, TagType tagType = TagType.Etc, bool value = false)
        : base(ownerCpu, owner, name, tagType, value)
    { }
}
