...
module RelayMarkerPath =
    ...
    type CoilTerminalExpression(expr:Expression) =
        do 
            match expr with
            | Terminal(_) -> ()
        ...
        interface IExpressionTerminal with
            ...
            member x.Equals t = t :? CoilTerminalExpression && x.ToText() = t.ToText()
    ...
    type CoilOriginType =
        ...
        | Coil of CoilTerminalExpression
    ...
    type CoilOriginTypeExt =
        ...
        static member toCoilOrigin (expr:Expression) =
            Coil(CoilTerminalExpression(expr))
