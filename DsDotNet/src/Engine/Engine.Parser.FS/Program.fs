...
[sys] DS_Units_V6 = {
    ...
    [jobs] = {
        ...
        "6 심볼 정의".Device1.ADV = { "6 심볼 정의_Device1".ADV(P00000:Boolean:Dev1ADV_I, P00040:Boolean:Dev1ADV_O); }
    ...
    [lamps] = {
        [a] = {
            AutoModeLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__AutoLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__AutoLamp2"(-, M0062E) = { "5 램프 IO"; }
        }
        [m] = {
            ManualModeLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__ManualLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__ManualLamp2"(-, M0062F) = { "5 램프 IO"; }
        }
        [d] = {
            DriveLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__DriveLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__DriveLamp2"(-, M00634) = { "5 램프 IO"; }
        }
        [e] = {
            ErrorLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__ErrorLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__ErrorLamp2"(-, M00631) = { "5 램프 IO"; }
        }
        [t] = {
            "2 시스템 버튼 램프 유닛__TestDriveLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__TestDriveLamp2"(-, M00635) = { "5 램프 IO"; }
        }
        [r] = {
            ReadyStateLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__ReadyLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__ReadyLamp2"(-, M00633) = { "5 램프 IO"; }
        }
        [i] = {
            IdleModeLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__IdleLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__IdleLamp2"(-, M00630) = { "5 램프 IO"; }
        }
        [o] = {
            OriginStateLamp(-, _) = {  }
            "2 시스템 버튼 램프 유닛__OriginLamp1"(_, _) = { "2 시스템 버튼 램프 유닛"; }
            "5 램프 IO__OriginLamp2"(-, M00632) = { "5 램프 IO"; }
        }
    }
    [conditions] = {
        [d] = {
