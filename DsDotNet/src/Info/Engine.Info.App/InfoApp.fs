...
//    let CountRising (tagKind: int, fqdn: string) =
//        ///////////
//        ///////////
//        /////////// 구현
//        ///////////
...
//    let GetONDurationAverage (tagKind: int, fqdn: string) =
//        0.0
//        (*
...
//        *)
//    let GetCountSum(dsLog:DsLog seq, tagKind: int, fqdn: string) = CountRising(tagKind, fqdn)
//    let GetAverage(tagKind: int, fqdn: string) = GetONDurationAverage (tagKind, fqdn)
module private dummyModule =
    ()