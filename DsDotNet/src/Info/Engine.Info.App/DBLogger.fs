...
type DBLogger() =
    ...
    static member internal GetAverageONDuration(fqdn, tagKind, logSet:LoggerInfoSet) = DBLoggerQueryImpl.getAverageONDuration(logSet, fqdn, tagKind)
    // }
    ...
    static member GetAverageONDuration       (fqdn, tagKind) = DBLoggerQueryImpl.getAverageONDuration(DBLoggerImpl.loggerInfo, fqdn, tagKind)
    static member GetAverageONDurationSeconds(fqdn, tagKind) = DBLogger.GetAverageONDuration(fqdn, tagKind).TotalSeconds
