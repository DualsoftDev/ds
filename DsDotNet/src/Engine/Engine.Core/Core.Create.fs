...
module CoreCreateModule =
    ...
    let createTaskDevUsingApiName (sys: DsSystem) (jobName:string) (devName: string) (apiName: string) (devParaIO:DevParaIO): TaskDev =
        ...
        TaskDev(api, jobName, devParaIO, devName, sys)
