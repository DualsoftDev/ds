...
module ExportToPdfModule =
    ...
    let convertDataSetToPdf (pdfFilePath: string) (dataTables: seq<DataTable>) =
        ...
        for dataTable in dataTables do
            ...
            // Set title font
            let titleFont =  new PdfTrueTypeFont("맑은 고딕", 14f, PdfFontStyle.Regular, true )
            ...
            table.Style.DefaultStyle.Font <- new PdfTrueTypeFont("맑은 고딕", 9f, PdfFontStyle.Regular, true )
