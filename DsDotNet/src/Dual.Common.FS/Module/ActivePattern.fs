[<AutoOpen>]
module Dual.Common.ActivePattern
...
let (|IpPattern|_|) (str: string) =
    /// [0..255] 범위의 숫자
    let n255 = "([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])"
    let regex_ip = $"^{n255}\.{n255}\.{n255}\.{n255}$"
    match str with
    | RegexPattern regex_ip [Int32Pattern n1; Int32Pattern n2; Int32Pattern n3; Int32Pattern n4] -> Some ([n1; n2; n3; n4])
    | _ -> None
...
let private do_test() =
    [ "kwak@dualsoft.co.kr"; "http://dualsoft.co.kr"; "192.168.0.4" ; "256" ]
        |> Seq.iter(fun str ->
            ...
            | IpPattern url -> printfn "Ip:%A" url
