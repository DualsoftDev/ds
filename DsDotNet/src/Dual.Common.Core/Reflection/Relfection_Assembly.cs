...
namespace Dsu.Common.Utilities
{
    public partial class Reflection
    {
        ...
        public static string GetAssemblyVersion() => Assembly.GetEntryAssembly().GetAssemblyVersion();
        public static string GetAssemblyVersion(this Assembly assembly) => assembly.GetName().Version.ToString();
    }
}