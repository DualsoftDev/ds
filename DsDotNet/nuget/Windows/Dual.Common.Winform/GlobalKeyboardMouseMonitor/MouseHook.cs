...
namespace Dual.Common.Winform
{
    ...
    public class MouseHook : GlobalHook
    {
        ...
        public IObservable<MouseEventArgs> ThrottledMouseMoveObservable;
        ...
        public MouseHook()
        {
            ...
            // MouseMove 이벤트에 대한 스로틀 적용 (예: 50ms 간격)
            ThrottledMouseMoveObservable = Observable
                .FromEventPattern<MouseEventHandler, MouseEventArgs>(
                    h => MouseMove += h,
                    h => MouseMove -= h)
                .Throttle(TimeSpan.FromMilliseconds(500))
                .DistinctUntilChanged(eventPattern => (eventPattern.EventArgs.X, eventPattern.EventArgs.Y)) // 중복된 좌표 제거
                .Select(eventPattern => eventPattern.EventArgs);

            ThrottledMouseMoveObservable.Subscribe(e => ThrottledMouseMove?.Invoke(this, e));
        }
