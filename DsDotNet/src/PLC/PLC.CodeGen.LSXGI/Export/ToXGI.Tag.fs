...
module XGITag = //IEC61131Tag =
    ...
    let createSymbolWithDetail (devicePos:int) addressIEC device (kind:int) address name comment plcType : SymbolInfo =
    ...
    let createSymbol = createSymbolWithDetail -1 "" "" (int Variable.Kind.VAR) ""
