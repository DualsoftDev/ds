...
namespace Dsu.Common.CS.LSIS.Actions
{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) 
		{
			...
			if (strValue != null) 
			{
				try
				{
					...
					return rs.GetReference(strValue);
				}
				catch
				{
					throw new ArgumentException("Can not convert '" + strValue + "' to type Object");
				}
			}
			return base.ConvertFrom(context, culture, strValue);
		}
		/// <summary>
	...
	internal class ActionCollectionEditor : CollectionEditor
	{
		...
		{
			Debug.Assert(editValue is ActionCollection);
