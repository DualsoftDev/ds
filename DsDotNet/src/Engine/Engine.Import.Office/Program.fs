...
module testMain =
    ...
    let main _ =
        ...
        let pptParms:PptParams = {HwTarget = getDefaltHwTarget();UserTagConfig= createDefaultUserTagConfig(); AutoIOM = true; CreateFromPpt = false; CreateBtnLamp = true; StartMemory = 1000; OpMemory = 100}
