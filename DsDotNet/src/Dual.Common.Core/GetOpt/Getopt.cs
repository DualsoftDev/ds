...
/* C#.NET Port Copyright (c) 2004 by Klaus Pr?kl (klaus.prueckl@aon.at)
/*
...
namespace Gnu.Getopt
{
	...
	/// <author>Klaus Pr?kl (klaus.prueckl@aon.at)</author>
	...
	public class Getopt
	{
		...
		private ResourceManager resManager = new ResourceManager(
            "Dsu.Common.Utilities.Core.GetOpt.MessagesBundle", Assembly.GetExecutingAssembly());
