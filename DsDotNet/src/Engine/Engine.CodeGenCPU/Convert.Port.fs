...
type StatementPort =
    ...
    ///Port bit 수식 만들기
    [<Extension>] 
    static member CreateStartPort(v:VertexMemeryManager, autoTag:DsTag<bool>) =
    ...
    [<Extension>] 
    static member CreateResetPort(v:VertexMemeryManager, autoTag:DsTag<bool>) =
    ...
    [<Extension>] 
    static member CreateEndPort(v:VertexMemeryManager, autoTag:DsTag<bool>, resetTag:DsTag<bool>) =
