...
namespace PresentationUtility
{
    public static class PowerpointHelper
    {
        ...
        public static Shape CreateRectangleShape(int left, int top, int width, int height, D.TextAnchoringTypeValues anchor, D.TextWrappingValues wrap, string fillColorCode = null)
        {
            if (width < 0)
            {
                throw new ArgumentOutOfRangeException("width", width, "width should be positive.");
        ...
        {
            return AddParagraph(shape, text,  D.TextAlignmentTypeValues.Center, fontSize, fontColorCode, bold);
        }
        ...
        public static D.Paragraph AddParagraph(Shape shape, string text,  D.TextAlignmentTypeValues align, int fontSize = 800, string fontColorCode = "212121", bool bold = false)
        {
            if (fontSize <= 0)
            {
