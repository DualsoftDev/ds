...
|Id| Item | Unit | Example | Desc |   GUI | 
|:---:|:----|:--:|:----|:---|:---|
|Seq5|Call | ~ |`C = A ~ B` | Action C indicates the end state of B by executing A<p>`C행위는 A를 수행시킴으로 B의 종료상태를 말함`| ![AAA](./png/Seq5.dio.png)|
|Seq6|And Call|,| `C = A,B,C ~ D,E`|Action C indicates the end state of D, E by executing A, B, C<p>`C행위는 A를 수행시킴으로 B의 종료상태를 말함`| ![AAA](./png/Seq6.dio.png)|
