...
global using static Engine.Core.Obsolete.GlobalShortCuts;
...
global using TagDic = System.Collections.Generic.Dictionary<string, Engine.Core.Obsolete.Tag>;
global using ButtonDic = System.Collections.Generic.Dictionary<string, Engine.Core.Obsolete.RootFlow[]>;
